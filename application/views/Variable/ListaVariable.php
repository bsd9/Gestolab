...
<?php
  ...
  <?php
    ...
    $data[]= [
     "<i style='color:green' onclick='ModalHistorial(\"". $var->getId() . "\")' class='material-icons tooltipped' data-position='bottom' data-delay=50 data-tooltip='Ver Precios'>assignment</i>",  
    $var->getTitulo(),
      "<div class='center'><a href=". site_url('variable/editar')."/".$var->getId()."><i style='color:orange' class='material-icons tooltipped' data-position='bottom' data-delay=50 data-tooltip='Editar'>edit</i></a></div>"
    ];?>
  <?php }?>
...
<script>
    ...
    var urlHistorial = '<?=site_url('Variable/historial')?>';
 ...
 var Acciones = new Array();
    Acciones[0] = '<li><a href="<?=site_url('variable/nuevo')?>" class="btn-floating btn-large blue darken-5 tooltipped" data-position="top" data-delay="20" data-tooltip="Nuevo"><i class="material-icons">add</i></a></li>'
    var AccionesHTML = '';
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/Variable/ListaVariable.js"></script>
