...
foreach ($ordenes as $orden) { ?>
    ...
    $data[] = [
        ...
        $helper,
        "
        <a href=". site_url('Cotizacion/nuevo')."/".$orden->getId()."><i style='color:green' class='material-icons tooltipped' data-position='bottom' data-delay=50 data-tooltip='Cotizar'>add_shopping_cart</i></a>"
...
<script>
 ...
 var Acciones = new Array();
    Acciones[0] = '<li><a href="<?=site_url('Ordenes/solicitarServicios')?>" class="btn-floating btn-large blue darken-5 tooltipped" data-position="top" data-delay="20" data-tooltip="Nuevo"><i class="material-icons">add</i></a></li>'
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/Ordenes/ListaOrdenes.js"></script>