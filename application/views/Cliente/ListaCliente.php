...
<tr>
  ...
  <th ><div class="text-center">Direccion</div></th>
  <th ><div class="text-center">Ciudad </div></th>
...
<?php
  ...
  <?php
    ...
    $pendientes = "";
    if($cli->solicitudes > 0){
    $pendientes =  "<i style='color:yellow;' class='material-icons tooltipped' data-tooltip='Por Cotizar'>report_problem</i>";
    }
    $data[]= [
    $pendientes . " " .$cli->getRazonSocial(),
    $cli->getNIT(),
    $cli->getTelefono(),
    $cli->getDireccion(),
    $cli->Ciudad,
    $helper,
      "<div class='center'><a href=". site_url('Cliente/users')."/".$cli->getId()."><i style='color:Azul' class='material-icons tooltipped' data-position='bottom' data-delay=50 data-tooltip='Usuarios'>supervisor_account</i></a>".
      "<a href=". site_url('Ordenes/listaOrdenesCliente')."/".$cli->getId()."><i style='color:green' class='material-icons tooltipped' data-position='bottom' data-delay=50 data-tooltip='Ordenes por   Cotizar'>add_shopping_cart</i></a>" .
      "<a href=". site_url('Ordenes/solicitarServiciosPorCliente')."/".$cli->getId()."><i style='color:red' class='material-icons tooltipped' data-position='bottom' data-delay=50 data-tooltip='Crear Orden Cliente'>note_add</i></a>" .
      "<a href=". site_url('Cliente/editar')."/".$cli->getId()."><i style='color:orange' class='material-icons tooltipped' data-position='bottom' data-delay=50 data-tooltip='Editar'>edit</i></a></div>"
    ];?>
  <?php }?>
...
<script>
    ...
    var idCliente;
    var urlNuevo = "<?=site_url('Pedidos/nuevo').'/'?>"
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/Cliente/ListaCliente.js"></script>
